      ...
      <div>
        <Form onSubmit={props.handleAddWord}>
          <FormField>
            ...
            <Input onChange={props.handleChange} value={props.wordValue} type="text" name="word" placeholder="Enter new word" />
          </FormField>
          <FormField>
            ...
            <input onChange={props.handleChange} value={props.definitionValue} type="text" name="definition" placeholder="Definition goes here" />
          </FormField>
          <FormField>
            ...
            <input onChange={props.handleChange} value={props.urlValue} type="text" name="url" placeholder="Enter image url" />
          </FormField>
